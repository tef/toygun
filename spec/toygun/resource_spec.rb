...
describe Toygun::ResourceTransition do
  let(:task) { Toygun::Resource.create}
...
describe Toygun::Resource do
  ...
  let (:dummy) { Toygun::DummyResource.create }

  describe 'Test' do
    it 'should exist' do
      expect(Toygun::DummyResource::Test.superclass).to be Toygun::Task
    end
  end

  it 'should not be running when not created' do
    obj = Toygun::DummyResource.create
